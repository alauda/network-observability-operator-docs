...
:::note
The CLI uses some images packaged in the Network Observability Operator, but it does not require the Network Observability Operator to be installed to work.
After you prepare the CLI, you can uninstall the Network Observability Operator if you no longer need it. The CLI will continue to work.
:::
