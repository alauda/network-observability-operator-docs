...
The console plugin is enabled by default.
After the FlowCollector instance is ready, open the cluster console and go to __Observe__ > __Network Traffic__ to inspect Overview, Flows, and Topology.
See [Use the Console](../how_to/console-usage.mdx) for the UI workflow.
